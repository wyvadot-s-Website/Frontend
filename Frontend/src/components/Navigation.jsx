      ...
      <div className="max-w-6xl mx-auto px-6 py-2 shadow-lg lg:rounded-full bg-white">
        <div className="flex justify-between items-center h-11 ">
          ...
          <div className="hidden lg:flex gap-6 items-center">
            ...
            <Link 
              to="/blog" 
              className={`font-medium transition-colors ${isActive('/blog') ? 'bg-[#FF8D28] text-black px-5 py-2 rounded-full' : 'text-gray-700 hover:text-orange-500'}`}
            >
              Blog
            </Link> */}
          </div>
          ...
          <div className="hidden md:flex gap-3 items-center">
            <button className="bg-[#FF8D28] text-white px-7 py-2 rounded-full hover:bg-orange-600 font-medium transition-colors text-sm lg:text-base whitespace-nowrap">
              Get Started
            </button>
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-4 space-y-3 border-t border-gray-200">
                <button className="w-full bg-[#FF8D28] text-black px-4 py-2.5 rounded-lg hover:bg-orange-600 font-medium transition-colors">
                  Book us now
                </button>
