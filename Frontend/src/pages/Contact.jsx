        ...
        <div className="flex flex-col md:flex-row gap-8 pt-20">
          ...
          <div className="bg-[#FF8D28] text-white rounded-lg p-8 md:w-2/5">
            ...
            <div className="flex gap-4 mt-8">
             <a href="https://web.facebook.com/people/Wyvadot-Projects-Resources-Ltd-Wyvadot-PR/100094277736606/" target="_blank" rel="noopener noreferrer">
             ...
             <a href="https://www.instagram.com/wyvadotpr/?igshid=MjEwN2IyYWYwYw%3D%3D" target='_blank'>
